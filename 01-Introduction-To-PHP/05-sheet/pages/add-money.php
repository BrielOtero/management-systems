				...
				<div class="card z-index-0">
					<div class="row justify-content-center">
						<div class="text-center mx-auto">
							<h1 class="text-black mb-2 mt-5">Add Money!</h1>
					...
					<form action="../database/addmoney.php" method="GET">
						<div class="card-body ">
							<div class="mb-3">
							...
							<div class="text-center">
								<input type="submit" value="Add" class="btn bg-gradient-dark w-100 my-4 mb-2"></input>
							</div>
						</div>
					</form>
				</div>
